...
CREATE TABLE `doctor1` (
  ...
  `jrdoctor_srdoctor` char(20) DEFAULT NULL,
...
INSERT INTO `doctor1` VALUES ('Rahul',5467,'srdoctor','guntur'),('Akram',8967,'jrdoctor','Hyderabad'),('Vishal',7890,'srdoctor','kerala'),('Koushik',5679,'srdoctor','guntur'),('Kishore',8965,'jrdoctor','guntur');
